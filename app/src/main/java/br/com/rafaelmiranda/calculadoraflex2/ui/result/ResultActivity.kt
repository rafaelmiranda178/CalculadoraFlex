package br.com.rafaelmiranda.calculadoraflex2.ui.result

import androidx.appcompat.app.AppCompatActivity
import android.os.Bundle
import android.widget.Toast
import br.com.rafaelmiranda.calculadoraflex2.R
import br.com.rafaelmiranda.calculadoraflex2.extensions.format
...
class ResultActivity : AppCompatActivity() {
    ...
    private fun calculate(){
        ...
        val ethanolPrice = intent.extras?.getDouble("ETHANOL_PRICE", 0.0) ?: 1.0
        val gasAverage = intent.extras?.getDouble("GAS_AVERAGE", 0.0) ?: 1.0
        val ethanolAverage = intent.extras?.getDouble("ETHANOL_AVERAGE", 0.0) ?: 1.0
